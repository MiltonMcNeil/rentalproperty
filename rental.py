class returnOnInvestment():
    ...
    def showExpenses(self):
        state_expense = (input(" What expense would you like to see? Tax, Insurance, Utilities, Repairs, Mortgage, Other: "))
              
        if state_expense.lower() == 'tax':
            tax = int(input("State your tax expense: "))
            self.expenses.append(tax)
              
        elif state_expense.lower() == 'insurance':
            insurance = int(input("State your insurance expense: "))
            self.expenses.append(insurance)
              
        elif state_expense.lower() == 'utilities':
            utilities = int(input("State your utilities expense: "))
